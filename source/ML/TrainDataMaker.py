...
def createTrainData(img_name,job_id,catchcopy_id):
	try:
		...
		url += "&url=http://deeptoneworks.com/profilemaker/faces/"+img_name
		...
		result = str(age)+","+str(gender)+","+str(smiling)+","+str(eye_x)+","+str(eye_y)+","+str(mouth_x)+","+str(mouth_y)+","+str(nose_x)+","+str(nose_y)+","+str(job_id)+","+str(catchcopy_id)
